...
public class QuickSelect
{
	...
	public int quickSelect(int[] data, int first, int last, int k)
	{
		if (first >= last)
			return first;
...
//		System.out.println( "7th smallest = " + array[ind]); 
		...
		int[] array2 = { 407, 766, 237, 761, 832, 1655, 421, 145, 688, 994, 915, 
				...
				41, 552, 287, 20, 253, 288, 907, 111, 883, 73, 473, 762, 4, 11, 42,42 };
...
//		System.out.println( "51st smallest = " + array2[ind]); 
		...
		ind = q.quickSelect(array2, 0, array2.length - 1, array2.length-(i+1));
		System.out.println( "highest = " + array2[ind]); 
		}
